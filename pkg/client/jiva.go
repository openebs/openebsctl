...
// ISCSISpec has info about ISCSISpec
...
// MountInfo has mounting info of a jivavolume
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (vd *VersionDetails) DeepCopyInto(out *VersionDetails) {
	*out = *vd
	vd.Status.DeepCopyInto(&out.Status)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VersionDetails.
func (vd *VersionDetails) DeepCopy() *VersionDetails {
	if vd == nil {
		return nil
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (vs *VersionStatus) DeepCopyInto(out *VersionStatus) {
	*out = *vs
	vs.LastUpdateTime.DeepCopyInto(&out.LastUpdateTime)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VersionStatus.
func (vs *VersionStatus) DeepCopy() *VersionStatus {
	if vs == nil {
		return nil
	}
